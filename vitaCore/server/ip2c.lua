...
function getPlayerCountry ( player )
	...
	if country == false then country = "Unknown" end
	return country
end
...
-- Load all IP groups from "IpToCountryCompact.csv"
...
if makeAndTestCompactCsv then
	...
	function makeCompactCsvWorker ()
		...
		local readFilename = "IpToCountry.csv";
		local hReadFile = fileOpen( readFilename, true )
		if not hReadFile then
			outputHere ( "Cannot read " .. readFilename )
			return
		...
		local writeFilename = "IpToCountryCompact.csv";
