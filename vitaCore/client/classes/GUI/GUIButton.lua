...
function GUIButton:render()
    dxDrawRectangle(self.diffX, self.diffY, self.w, self.h, self.drawColor)
    dxDrawText(self.title, self.diffX, self.diffY, self.diffX + self.w, self.diffY + self.h, tocolor(255, 255, 255, self.alpha), 1.3, "default-bold", "center", "center")
end