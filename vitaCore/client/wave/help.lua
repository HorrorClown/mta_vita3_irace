...
function waveDrawHelp()
	...
	elseif guiComboBoxGetSelected ( helpBox ) == 1 then
		...
		if getPlayerGameMode(getLocalPlayer()) == 4 then					dxDrawShadowedText("/banPlayer | /pban [player] [minutes] - Bans a player for a certain time.",screenWidth/2-392,screenHeight/2+140, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)
		else
		end
