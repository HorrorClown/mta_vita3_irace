...
function waveDrawHelp()
	...
	elseif guiComboBoxGetSelected ( helpBox ) == 1 then
		...
		dxDrawShadowedText("/fixMap [Mapname] - Marks a map to fix.",screenWidth/2-392,screenHeight/2, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)
		dxDrawShadowedText("/deleteMap [Mapname] - Marks a map to delete.",screenWidth/2-392,screenHeight/2 + 15, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)

		dxDrawShadowedText("Senior Member Commands",screenWidth/2-392,screenHeight/2+35, screenWidth, screenHeight, tocolor(214,219,145,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1, ms_bold_12 , "left", "top", false, false, false, true)
		dxDrawShadowedText("/banPlayer | pban [player] [minutes] - Bans a player from the server (0 for permaban).",screenWidth/2-392,screenHeight/2+55, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)

		dxDrawShadowedText("Moderator Commands",screenWidth/2-392,screenHeight/2+75, screenWidth, screenHeight, tocolor(214,219,145,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1, ms_bold_12 , "left", "top", false, false, false, true)
		dxDrawShadowedText("/deletetime [ID] - Deletes a toptime with the given ID.",screenWidth/2-392,screenHeight/2+95, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)
		dxDrawShadowedText("/redo - Requeue the current map.",screenWidth/2-392,screenHeight/2+110, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)
		dxDrawShadowedText("/skipMap - Skips the current map.",screenWidth/2-392,screenHeight/2+125, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)
		dxDrawShadowedText("/setnextmap [Mapname] - Set the next map for the current gamemode.",screenWidth/2-392,screenHeight/2+140, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)
	elseif guiComboBoxGetSelected ( helpBox ) == 2 then
		...
		dxDrawShadowedText("/badumtss - Nope.",screenWidth/2-392,screenHeight/2-220, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)

		dxDrawShadowedText("Leader Commands",screenWidth/2-392,screenHeight/2-200, screenWidth, screenHeight, tocolor(214,219,145,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1, ms_bold_12 , "left", "top", false, false, false, true)
		dxDrawShadowedText("/setlevel [player] [level] - Change the level of somebody on the server.",screenWidth/2-392,screenHeight/2-180, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)
		dxDrawShadowedText("/setpoints [player] [points] - Set a players points to a different ammount.",screenWidth/2-392,screenHeight/2-165, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)
		dxDrawShadowedText("/setmoney [player] [money] - Give somebody more or less money than he had before.",screenWidth/2-392,screenHeight/2-150, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)
		dxDrawShadowedText("/setrights [player] [User/Member/...] - Welcome a player to Vita, or to simply tell him to GTFO.",screenWidth/2-392,screenHeight/2-135, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)
		dxDrawShadowedText("/setmemeacc [player] [0/1] - Allow a player to use memes or not.",screenWidth/2-392,screenHeight/2-120, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)
		dxDrawShadowedText("/addachievement [player] [ID] - Manually give a player an achievement.",screenWidth/2-392,screenHeight/2-105, screenWidth, screenHeight, tocolor(255,255,255,255*waveAlpha*waveMenuAlpha),tocolor(0,0,0,255*waveAlpha*waveMenuAlpha), 1,"default-bold", "left", "top", false, false, false, true)
