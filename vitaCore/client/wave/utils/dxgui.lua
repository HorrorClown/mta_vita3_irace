...
function dxGridListAddRowAndBottom(element, text, data)
	if isElement(element) then
		local gridTable = getElementData(element, "grid")
		if not data then data = false end
		gridTable[#gridTable+1] = {}
		...
		local height = getElementData(element, "h")
	
		setElementData(element, "scroll", #gridTable-height/20+1)
		return #gridTable
	end
	return false
end
...
function dxDrawAllOfThis ()
	for id, v in ipairs (getElementsByType("dxGridList")) do
		if getElementData(v, "isShown") == true then
			...
			local line = 0
			if #gridTable == maxDisplay then maxDisplay = maxDisplay+1 end
		...
		if getElementData(v, "isShown") == true then
			if getElementData(v, "enabled") == true then
				if getElementData(v, "clickedDown") == true then
					...
					dxDrawImageSection( getElementData(v,"x"), getElementData(v,"y"), getElementData(v,"w"), getElementData(v,"h"),0,0, getElementData(v,"w"), getElementData(v,"h"), "files/wave/gui/buttonclicked.png", 0,0,0, tocolor(255,255,255,255*getElementData(v,"alpha")))
				else
					if dxIsHovering(v) then
						dxDrawRectangle ( getElementData(v,"x")-1, getElementData(v,"y")-1, getElementData(v,"w")+2, getElementData(v,"h")+2, tocolor(0,0,0,100*getElementData(v,"alpha")) )
						dxDrawImageSection( getElementData(v,"x"), getElementData(v,"y"), getElementData(v,"w"), getElementData(v,"h"),0,0, getElementData(v,"w"), getElementData(v,"h"), "files/wave/gui/buttonhover.png", 0,0,0, tocolor(255,255,255,255*getElementData(v,"alpha")))						
					else
						dxDrawRectangle ( getElementData(v,"x")-1, getElementData(v,"y")-1, getElementData(v,"w")+2, getElementData(v,"h")+2, tocolor(0,0,0,100*getElementData(v,"alpha")) )
						dxDrawImageSection( getElementData(v,"x"), getElementData(v,"y"), getElementData(v,"w"), getElementData(v,"h"),0,0, getElementData(v,"w"), getElementData(v,"h"), "files/wave/gui/button.png", 0,0,0, tocolor(255,255,255,255*getElementData(v,"alpha")))			
					end
				end
			else
				dxDrawRectangle ( getElementData(v,"x")-1, getElementData(v,"y")-1, getElementData(v,"w")+2, getElementData(v,"h")+2, tocolor(0,0,0,100*getElementData(v,"alpha")) )
				dxDrawImageSection( getElementData(v,"x"), getElementData(v,"y"), getElementData(v,"w"), getElementData(v,"h"),0,0, getElementData(v,"w"), getElementData(v,"h"), "files/wave/gui/buttonclicked.png", 0,0,0, tocolor(150,150,150,255*getElementData(v,"alpha")))			
			end
